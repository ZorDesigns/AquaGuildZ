...
<a href="#" class="important_notices"><p>Failed inserting topic / reply! There was an error in the Core!</p></a>
<p class="tac">Speak with the Administrator as soon as possible!</p>
<!--Form-->
<form id="lockScreenForm" role="form" action="forums.php" class="login-form">
<meta http-equiv='refresh'content='5;url=forums.php'>
