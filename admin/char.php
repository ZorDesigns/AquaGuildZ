...
<div class="col-sm-9">
<?php
$PlayerName = 'Baldazzar'; // ADD NAME HERE
...
<?php 
{
echo "<strong>Baldazzar</strong> does <strong>not</strong> exist in the Database.";
}
?>
</div>
<div class="syntax-wrapper">
...
<div class="col-sm-9">
<textarea id="autogrowTextarea" rows="3" placeholder="" class="form-control" style="overflow: hidden; resize: none; height: 71px;">
<?php echo "INSERT INTO `table` SET $sqlclause"; ?>
</textarea>
</div>
</div>
</div>
