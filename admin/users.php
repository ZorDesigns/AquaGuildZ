...
<td>' . $row[6] . '</td>
<td>' . $row[7] . '</td>
<td><a href="edit-user.php?id=' . $row[0] . '" type="button" class="btn btn-primary btn-sm">Edit</a></td>
</tr>                      
</tbody>';
}
// Closing the Table
...
{
echo '<a href="test.php?page='.$i.'" class="paginate_button" aria-controls="dataTableIdResponsive" data-dt-idx="'.$i.'" tabindex="0">'.$i.'</a> ';
}
}
echo "</span></div>";
?>
